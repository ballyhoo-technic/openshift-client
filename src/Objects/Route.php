...
class Route extends ObjectBase {
     ...
     * @var string
     */
    protected string $insecureEdgeTerminationPolicy;
     ...
     * @var string|null
     */
    protected ?string $wildcardPolicy;
     ...
     *   The calling class.
     */
    public function setInsecureEdgeTerminationPolicy(string $insecureEdgeTerminationPolicy): Route {
