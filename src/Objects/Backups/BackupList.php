...
class BackupList extends ObjectListBase {
     ...
     */
    public static function create(): BackupList {
        return new static();
    }
     ...
     */
    public function getBackupsByCreatedTime(string $operator = 'DESC'): array {
     ...
     *   The sorted array.
     */
    protected function sortBackupsByStartTime(array $backups, string $operator): array {
     ...
     *   The list of backups.
     */
    public function getBackupsByStartTime(string $operator = 'DESC'): array {
     ...
     *   The list of backups.
     */
    public function getCompletedBackupsByStartTime(string $operator = 'DESC'): array {
