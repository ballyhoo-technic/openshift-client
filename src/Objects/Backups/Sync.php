...
class Sync extends ObjectBase {
     ...
     * @var Database[]
     */
    protected array $backupDatabases = [];
     ...
     * @var array
     */
    protected array $restoreVolumes = [];
     ...
     * @var Database[]
     */
    protected array $restoreDatabases = [];
     ...
     *
     * @param Database[] $backupDatabases
     ...
     *
     * @param Database[] $restoreDatabases
